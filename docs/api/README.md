# API 契约导航与通用规范（通用规范 v2.1；第 4 批响应裁决后已锁定）

> 状态：通用规范 **v2.1 已定稿**；第 4 批相关契约已于 **2026-08-21 锁定**，收货契约随后经契约责任人完成成功响应缺口裁决并升至 v0.6。本页导航所列锁定版本是第 4 批实现的唯一契约基线。
...
| 2026-08-21 | 第 4 批收货成功响应裁决：`收货.md` 升至 v0.6，明确质检/resolve 为 `200 + Receipt`、上架为 `201 + Receipt` |
