# API 契约导航与通用规范（通用规范 v2.1；第 4 批待复核）

> 状态：通用规范 **v2.1 已定稿**。第 4 批开工评审意见已裁决并回写；标记“修订草案”的版本正等待前后端复核，复核无异议并重新锁定前不得作为实现开工许可。
...
| 枚举与错误码.md | 全部枚举与错误码 | 📝 第 4 批修订草案 v1.9（待复核；基线 v1.7 已锁定） |
| 物料.md / 仓库库位.md / 来源.md | 主数据 | 🔒 锁定 v0.5 / v0.4 / v0.4；第 3 批已实现 |
| 批次.md | 主数据（系统自动建批次） | 🔒 锁定 v0.7；第 3 批已实现查询 |
| 认证权限.md | 登录、用户、角色、权限、菜单 | 📝 第 4 批修订草案 v0.4（待复核；v0.3 已实现） |
| 入库单.md / 收货.md | 入库链 | 📝 第 4 批修订草案 v0.5（待复核；基线 v0.3 已锁定） |
| 库存.md / 工作台.md | 库存与聚合 | 🔒 锁定 v0.3 / v0.1；待第 5 批实现 |
| 标签解析.md / 附件.md / 打印.md | 收货链支撑能力 | 📝 第 4 批修订草案 v0.2 / v0.3 / v0.4（待复核） |
| 导入导出.md | 平台导入导出能力 | 🔒 锁定 v0.2；第 3 批已实现物料模块 |
| 数据模型-草案.md | 概念级数据模型（C-02 依据） | 📝 第 4 批修订草案 v0.6（待复核；基线 v0.4 已锁定） |
